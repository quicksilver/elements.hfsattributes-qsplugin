...
@implementation QSFileTaggingAction
...
- (void)updateTagsOnDisk
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:QSCatalogEntryInvalidatedNotification object:kQSFileTagsPreset];
}
